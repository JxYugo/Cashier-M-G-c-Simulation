...
class QueueApp:
    ...
    def start_sim(self):
        try:
            ...
            self.max_samples = int(self.entries["Max Samples"].get())  
        except ValueError:
            return
    ...
    def create_customer(self):
        ...
        self.queue.append(
            {"circle": c, "text": t, "arrival": self.time, "id": self.id_counter})  
        self.id_counter += 1
    ...
    def validate(self):
        ...
        if theo_mean == float('inf') or rho >= 1:
            ...
            report += f"Valid Samples:   {len(self.wait_times)}"  
